...
static const CGFloat CSToastTitleFontSize       = 16.0;
static const CGFloat CSToastMessageFontSize     = 12.0;
...
- (void)makeToastActivityWithMessage:(NSString *)message position:(id)position
{
    ...
    if (message != nil) {
        ...
        messageLabel.font = [UIFont boldSystemFontOfSize:CSToastTitleFontSize];
...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    if (message != nil) {
        messageLabel = [[UILabel alloc] init];
        messageLabel.numberOfLines = CSToastMaxMessageLines;
        messageLabel.font = [UIFont systemFontOfSize:CSToastMessageFontSize];
        messageLabel.lineBreakMode = NSLineBreakByWordWrapping;
        messageLabel.textColor = [UIColor whiteColor];
        messageLabel.backgroundColor = [UIColor clearColor];
        messageLabel.alpha = 1.0;
